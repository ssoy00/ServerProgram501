...
<%--         register.jsp 의 화면을 복붙--%>
  <form method="post" action="/lunch/update">
    ...
    <div class="mb-3">
      ...
      <input type="date" name="dueDate" class="form-control" id="dueDate" value="${lunchDTO.dueDate}" >
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="checkbox" class="form-check-input" id="finished" name="finished" ${lunchDTO.finished ? "checked" :""}>
    </div>
